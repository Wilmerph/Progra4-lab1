...
export const SpeakerSchema = z.object({
    ...
    isAnnounced: z.boolean().describe(JSON.stringify({
        label: 'Announced',
    })),
    isHidden: z.boolean().describe(JSON.stringify({
        label: 'Hidden',
    })),
    ...
    occupation: z.string().describe(JSON.stringify({
        label: 'Occupation',
    })),
    bio: z.string().describe(JSON.stringify({
        label: 'Bio',
    ...
    settings: SpeakerSettingsSchema.describe(JSON.stringify({
        label: 'Settings',
    ...
    imageId: z.number().describe(JSON.stringify({
        label: 'Image Id',
    })),
