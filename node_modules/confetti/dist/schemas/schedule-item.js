...
export const ScheduleItemSchema = z.object({
    ...
    location: z.string().describe(JSON.stringify({
        label: 'Location',
    })),
    start: z.date().describe(JSON.stringify({
        label: 'Start',
    })),
    ...
    duration: z.number().describe(JSON.stringify({
        label: 'Duration',
        description: 'Duration in minutes',
    })),
    settings: ScheduleItemSettingsSchema.describe(JSON.stringify({
        label: 'Settings',
