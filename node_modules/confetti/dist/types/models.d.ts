...
export type { Category, Contact, ContactCreate, Event, Ticket, TicketCreate, Payment, Webhook, WebhookCreate, Workspace, TicketBatch, Block, Image, Page, ScheduleItem, Speaker, Organiser, Addon, };
export type ConfettiModel = Category | Contact | Event | Ticket | Payment | Webhook | Workspace | TicketBatch | Block | Image | Page | ScheduleItem | Speaker | Organiser | Addon;
